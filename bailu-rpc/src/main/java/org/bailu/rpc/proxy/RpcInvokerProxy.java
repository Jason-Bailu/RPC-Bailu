package org.bailu.rpc.proxy;

import io.netty.channel.DefaultEventLoop;
import io.netty.util.concurrent.DefaultPromise;
import lombok.extern.slf4j.Slf4j;
import org.bailu.rpc.common.*;
import org.bailu.rpc.constant.MsgType;
import org.bailu.rpc.constant.ProtocolConstants;
...
import static org.bailu.rpc.constant.FaultTolerantRules.*;
...
public class RpcInvokerProxy implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        long requestId = RpcLinkHolder.REQUEST_ID_GEN.incrementAndGet();
        ...
        while (count <= retryCount ){
            ...
            // XXXHolder
            RpcLinkHolder.REQUEST_MAP.put(requestId, future);
            try {
                // 发送消息
